...
namespace OpenRA.Traits
{
	...
	/// <summary>This trait [interface] should only exist once per actor.</summary>
	...
	public interface IImplicitTraitInfo : ISingletonTraitInfo { }
	...
	[SuppressMessage("StyleCop.CSharp.NamingRules", "SA1302:InterfaceNamesMustBeginWithI", Justification = "Not a real interface, but more like a tag.")]
	public interface RequiresOrAdds<T> where T : class, IImplicitTraitInfo { }
	[SuppressMessage("StyleCop.CSharp.NamingRules", "SA1302:InterfaceNamesMustBeginWithI", Justification = "Not a real interface, but more like a tag.")]
